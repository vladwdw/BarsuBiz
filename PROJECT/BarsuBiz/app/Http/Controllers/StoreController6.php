...
class StoreController6 extends Controller
{
    public function store(Request $request){
      ...
      public function update_rcpi_pass_checkboxes($request, $id){
        ...
        'Нет аналогов за рубежом, есть в стране','Есть сведения об отечественных и зарубежных аналогах','Другoе (указать):','Идея','Разработана документация (научно-техническая, проектно-сметная, конструкторская, технологическая и др.)',
